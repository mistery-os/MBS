...
cond_syscall(sys_prambind);
cond_syscall(sys_get_mempolicy);
cond_syscall(sys_set_mempolicy);
cond_syscall(compat_sys_mbind);
cond_syscall(compat_sys_prambind);
cond_syscall(compat_sys_get_mempolicy);
cond_syscall(compat_sys_set_mempolicy);
cond_syscall(sys_get_prampolicy);
cond_syscall(sys_set_prampolicy);
cond_syscall(compat_sys_get_prampolicy);
cond_syscall(compat_sys_set_prampolicy);
