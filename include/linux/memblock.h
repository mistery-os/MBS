...
//<<<2018.02.13 Yongseob
int memblock_add_node_pram(phys_addr_t base, phys_addr_t size, int nid);
int memblock_add_pram(phys_addr_t base, phys_addr_t size);
//>>>
...
//<<<2018.02.13 Yongseob
void memblock_trim_pram(phys_addr_t align);
//>>>
...
#define for_each_pfn_range(i, nid, p_start, p_end, p_nid)		\
	for (i = -1, __next_pfn_range(&i, nid, p_start, p_end, p_nid); \
	     i >= 0; __next_pfn_range(&i, nid, p_start, p_end, p_nid))
//<<<2018.02.13 Yongseob
#define for_each_pram_pfn_range(i, nid, p_start, p_end, p_nid)		\
	for (i = -1, __next_pram_pfn_range(&i, nid, p_start, p_end, p_nid); \
	     i >= 0; __next_pram_pfn_range(&i, nid, p_start, p_end, p_nid))
//>>>
